 ...
 * source: https://www.cnblogs.com/zjl6/p/6798485.html
 */
public class calendarUtil extends JPanel{
    ...
    private calendarUtil(java.util.Date date, String format, int startDAY){
    ...
    public static calendarUtil getInstance(java.util.Date date, String format){
        return new calendarUtil(date, format, defaultStartDAY);
    }

    public static calendarUtil getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static calendarUtil getInstance(String format){
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<calendarUtil.DayLabel>();
        }
